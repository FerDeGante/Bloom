...
async function handler(req, res) {
    ...
    const match = await __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__["default"].compare(currentPassword, user.password);
    if (!match) return res.json({
        ok: false,
        error: "Contraseña actual incorrecta"
    });
    const hash = await __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__["default"].hash(newPassword, 10);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__888c1484._.js.map